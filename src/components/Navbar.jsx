...
export const KanglaShaIcon = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      d="M50 5 L65 25 L85 20 L75 40 L95 55 L75 65 L80 85 L50 75 L20 85 L25 65 L5 55 L25 40 L15 20 L35 25 Z"
      fill="#D4AF37"
      stroke="#7A0016"
      strokeWidth="3"
    />
    ...
    />
    <path
      d="M50 33 L53 41 L61 41 L55 46 L57 54 L50 49 L43 54 L45 46 L39 41 L47 41 Z"
      fill="#D4AF37"
    />
  </svg>
);
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-manipuri-gold/80 font-meitei font-medium">
                {lang === "meetei"
                  ? "ꯆꯩꯊꯥꯔꯣꯜ ꯀꯨꯝꯕꯥꯕ (꯳꯳–꯱꯹꯴꯹)"
                  : "Manipuri History (33 CE – 1949)"}
              </p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-1 bg-manipuri-panelDark/80 p-1.5 rounded-full border border-manipuri-borderGold/60">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <Icon
                    className={`w-3.5 h-3.5 ${isActive ? "text-manipuri-gold" : "text-slate-400"}`}
                  />
